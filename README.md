...
[![Build and run tests](https://github.com/kodi-pvr/pvr.filmon/actions/workflows/build.yml/badge.svg?branch=Matrix)](https://github.com/kodi-pvr/pvr.filmon/actions/workflows/build.yml)
...
2. `git clone --branch Matrix https://github.com/kodi-pvr/pvr.filmon.git`
